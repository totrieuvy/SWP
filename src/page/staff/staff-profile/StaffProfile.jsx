...
function StaffProfile() {
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      const response = await api.put(`/api/staff/${user.id}`, {
      ...
      console.log(response.data);
      setStaffProfile({ ...response.data, image: imageToUpdate });
  ...
  const handleCancelEdit = () => {
    ...
    setImageBase64(staffProfile.image);
    setIsEditing(false);
  };
                  ...
                  <div style={{ flex: 1, paddingLeft: 20 }}>
                    ...
                    >
                      {isEditing ? (
                        ...
                        <img
                          src={imageBase64 || staffProfile.image}
                          alt="Staff Profile"
                          style={{
                            width: "100%",
                            height: "100%",
